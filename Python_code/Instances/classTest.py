...
combine_input = '/disk1/turner/DATA/Gals1/K/obs_09/Calibrations/combine_input.txt'
sci_dir = '/disk1/turner/DATA/Gals1/K/obs_09/Science'
...
pipe_methods.combine_by_name(sci_dir, combine_input, 0, 5.0, 30.0)
